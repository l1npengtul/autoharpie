...
(library Library_1
	...
	(patternDef "SDS50J" (originalName "SDS50J")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -7.150, -4.512) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -17.5 -12.5) (pt 2.5 -12.5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.5 -12.5) (pt 2.5 3.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.5 3.3) (pt -17.5 3.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -17.5 3.3) (pt -17.5 -12.5) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "SDS-50J" (originalName "SDS-50J") (compHeader (numPins 9) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.mouser.com/datasheet/2/670/sds-xxj-1312653.pdf")
		(attr "<Component Height>" "21.1")
		(attr "<STEP Filename>" "SDS-50J.stp")
